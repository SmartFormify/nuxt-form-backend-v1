# Nuxt Restaurant reservation request Example

This is a reservation request, not a real-time availability system.

## Fields included

Name, email, phone, preferred date, preferred time, party size, and special request.
