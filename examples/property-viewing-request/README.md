# Nuxt Property viewing request Example

Request a property viewing with alternative timing.

## Fields included

Name, email, phone, property reference, preferred date, alternate date, and message.
