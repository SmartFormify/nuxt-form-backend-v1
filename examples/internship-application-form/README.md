# Nuxt Internship application Example

A focused application for an internship opportunity.

## Fields included

Full name, email, school, internship area, portfolio URL, and motivation.
