# Nuxt Sponsorship request form Example

Collect sponsorship requests for evaluation.

## Fields included

Name, organization, email, event or project, audience size, amount requested, and proposal.
