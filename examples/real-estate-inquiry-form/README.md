# Nuxt Real estate inquiry form Example

Capture property interest without making availability promises.

## Fields included

Name, email, phone, property reference, buyer or renter status, budget, and message.
