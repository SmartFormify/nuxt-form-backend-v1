# Nuxt Bug report form Example

Collect enough detail for a reproducible issue.

## Fields included

Email, product area, severity, expected behavior, actual behavior, and reproduction steps.
