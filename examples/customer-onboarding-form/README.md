# Nuxt Customer onboarding form Example

Collect implementation preferences after a sale.

## Fields included

Name, work email, company, account goal, team size, and onboarding notes.
