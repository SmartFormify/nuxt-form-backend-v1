# Nuxt Course registration Example

Capture course interest and scheduling preference.

## Fields included

Student name, email, course, experience level, schedule preference, and message.
